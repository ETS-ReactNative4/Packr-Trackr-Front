...
//                 </View > */}
//                 <Stack key="root">
//                     <Scene key="landing" component={Landing} loginOptionHandler={this.props.loginOptionHandler} signupButtonClick={this.props.signupButtonClick} loginButtonClick={this.props.loginButtonClick} {...this.props} title='Packr Trackr' initial />
//                     <Scene renderBackButton={() => (null)}
//                         key="login" component={Login} inputHandler={this.props.inputHandler} submitHandler={this.props.submitHandler} {...this.props} title="Login" />
//                     <Scene renderBackButton={() => (null)}
//                         key="signup" component={Signup} inputHandler={this.props.inputHandler} submitHandler={this.props.submitHandler} {...this.props} title="Sign Up" />
//                 </Stack>
//             </Router>
//         )
//     }
